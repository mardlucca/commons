/*
 * File: ShortWrapperToPrimitiveConverterDecorator.java
 *
 ...
 */
public class ShortWrapperToPrimitiveConverterDecorator<T>
        implements Converter<T, short[]> {
    private Converter<T, Short[]> delegateConverter;

    public ShortWrapperToPrimitiveConverterDecorator(
            Converter<T, Short[]> aInDelegateConverter) {
        delegateConverter = aInDelegateConverter;
    }

    @Override
    public short[] convert(T aInFrom) {
