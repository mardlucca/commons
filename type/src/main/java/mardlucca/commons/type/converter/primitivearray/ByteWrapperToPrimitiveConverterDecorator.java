/*
 * File: ByteWrapperToPrimitiveConverterDecorator.java
 *
 ...
 */
public class ByteWrapperToPrimitiveConverterDecorator<T>
        implements Converter<T, byte[]> {
    private Converter<T, Byte[]> delegateConverter;

    public ByteWrapperToPrimitiveConverterDecorator(
            Converter<T, Byte[]> aInDelegateConverter) {
        delegateConverter = aInDelegateConverter;
    }

    @Override
    public byte[] convert(T aInFrom) {
