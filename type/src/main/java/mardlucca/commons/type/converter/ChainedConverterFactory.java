 ...
 */
public abstract class ChainedConverterFactory
        implements ConverterFactory {

    public abstract List<ChainingConverterFactory> getFactories();
    ...
    private class ChainImpl implements FactoryChain {
        ...
        public <F, T> Converter<F, T> invokeNext(Type aInFrom, Type aInTo) {
            currentFactory++;
            List<ChainingConverterFactory> lFactories = getFactories();
