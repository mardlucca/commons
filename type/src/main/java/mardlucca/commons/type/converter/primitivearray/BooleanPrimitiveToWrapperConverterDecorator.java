/*
 * File: BooleanPrimitiveToWrapperConverterDecorator.java
 *
 ...
 */
public class BooleanPrimitiveToWrapperConverterDecorator<T>
        implements Converter<boolean[], T> {
    private Converter<Boolean[], T> delegateConverter;

    public BooleanPrimitiveToWrapperConverterDecorator(
            Converter<Boolean[], T> aInDelegateConverter) {
        delegateConverter = aInDelegateConverter;
    }

    @Override
    public T convert(boolean[] aInFrom) {
