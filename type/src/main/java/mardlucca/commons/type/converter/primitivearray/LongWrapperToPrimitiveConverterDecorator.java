/*
 * File: LongWrapperToPrimitiveConverterDecorator.java
 *
 ...
 */
public class LongWrapperToPrimitiveConverterDecorator<T>
        implements Converter<T, long[]> {
    private Converter<T, Long[]> delegateConverter;

    public LongWrapperToPrimitiveConverterDecorator(
            Converter<T, Long[]> aInDelegateConverter) {
        delegateConverter = aInDelegateConverter;
    }

    @Override
    public long[] convert(T aInFrom) {
