/*
 * File: IntWrapperToPrimitiveConverterDecorator.java
 *
 ...
 */
public class IntWrapperToPrimitiveConverterDecorator<T>
        implements Converter<T, int[]> {
    private Converter<T, Integer[]> delegateConverter;

    public IntWrapperToPrimitiveConverterDecorator(
            Converter<T, Integer[]> aInDelegateConverter) {
        delegateConverter = aInDelegateConverter;
    }

    @Override
    public int[] convert(T aInFrom) {
