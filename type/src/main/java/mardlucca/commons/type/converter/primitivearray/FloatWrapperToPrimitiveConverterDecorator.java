/*
 * File: FloatWrapperToPrimitiveConverterDecorator.java
 *
 ...
 */
public class FloatWrapperToPrimitiveConverterDecorator<T>
        implements Converter<T, float[]> {
    private Converter<T, Float[]> delegateConverter;

    public FloatWrapperToPrimitiveConverterDecorator(
            Converter<T, Float[]> aInDelegateConverter) {
        delegateConverter = aInDelegateConverter;
    }

    @Override
    public float[] convert(T aInFrom) {
