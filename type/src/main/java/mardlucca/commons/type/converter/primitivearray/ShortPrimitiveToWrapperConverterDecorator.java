/*
 * File: ShortPrimitiveToWrapperConverterDecorator.java
 *
 ...
 */
public class ShortPrimitiveToWrapperConverterDecorator<T>
        implements Converter<short[], T> {
    private Converter<Short[], T> delegateConverter;

    public ShortPrimitiveToWrapperConverterDecorator(
            Converter<Short[], T> aInDelegateConverter) {
        delegateConverter = aInDelegateConverter;
    }

    @Override
    public T convert(short[] aInFrom) {
