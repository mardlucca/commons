/*
 * File: BytePrimitiveToWrapperConverterDecorator.java
 *
 ...
 */
public class BytePrimitiveToWrapperConverterDecorator<T>
        implements Converter<byte[], T> {
    private Converter<Byte[], T> delegateConverter;

    public BytePrimitiveToWrapperConverterDecorator(
            Converter<Byte[], T> aInDelegateConverter) {
        delegateConverter = aInDelegateConverter;
    }

    @Override
    public T convert(byte[] aInFrom) {
